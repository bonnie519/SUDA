...
<html>
  <head>
    ...
    <style type="text/css">
       ...
       #tableinfo{margin:25px auto; width:100%;}
       #tbtt{text-align:center; font-size:20;}
	#btnmenu{float:left;}
    </style>
    <title></title>
</head>
	...
	<div class="navbar-header">
		...
		<div id="mnav">
			<ul class="nav navbar-nav navbar-left">
				...
				<li id="usr" class="dropdown activee">
            	<a href="#" class="dropdown-toggle" data-toggle="dropdown">
	            	...
	            	<ul class="dropdown-menu" role="menu">
	               		...
	               		<!--<li class="divider"></li>-->
	               		<li class="active"><a href="qry_sta.action">站点信息</a></li>
	            	</ul>
         		</li>
...
<div class="slides">
			...
			<a title="" target="_blank" href="indx.jsp">
 ...
 <div id="tableinfo">
     <div id="tbtt">苏州公共自行车站点信息</div>
      <display:table name="${stainfo}" requestURI="qry_sta.action" pagesize="3" export="true" class="table table-striped table-hover">
      <display:column class="info" property="city" title="城市"/>
      <display:column class="info" property="district" title="地区"/>
      <display:column class="info" property="stationno" title="站点号"/>
      <display:column class="info" property="stationname" title="站点名称"/>
      <display:column class="info" property="rentable" title="可借数"/>
      <display:column class="info" property="returnable" title="可还数"/>
    </display:table>
 </div>
 </div>
 </div>
