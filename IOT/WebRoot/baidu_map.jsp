...
<%@ taglib uri="http://displaytag.sf.net" prefix="display" %>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=1.5&ak=Coeu9ONArhi2YsgiMpxgLu4k"></script>
  ...
  <body class="page-header-fixed">
					...
					<div class="span12">
						<div class="portlet box blue ">
							<div class="portlet-title">
								<div class="caption  offset5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;百度地图实时监控</div>
							</div>
	...
	<script type="text/javascript"> 
        ...
        var marker1 = new BMap.Marker(new BMap.Point(120.64657,31.312513));  // 创建标注
        map.addOverlay(marker1);              // 将标注添加到地图中

		//创建信息窗口
		var infoWindow1 = new BMap.InfoWindow("<p style='font-size:14px;'>苏大文星阁 </p><p style='font-size:14px;'>温度:25.6  湿度:0.65</p><p style='font-size:14px;'>温湿度均正常</p>");
		marker1.addEventListener("click", function(){this.openInfoWindow(infoWindow1);});
		
		var marker2 = new BMap.Marker(new BMap.Point(120.648466,31.30701));  // 创建标注
        map.addOverlay(marker2);              // 将标注添加到地图中
		var infoWindow2= new BMap.InfoWindow("<p style='font-size:14px;'>苏大博物馆 </p><p style='font-size:14px;'>温度:25.7  湿度:0.65</p><p style='font-size:14px;'>温湿度均正常</p>");
		marker2.addEventListener("click", function(){this.openInfoWindow(infoWindow2);});
		
		
        var marker3 = new BMap.Marker(new BMap.Point(120.649113,31.307434));  // 创建标注
        map.addOverlay(marker3);              // 将标注添加到地图中
		var infoWindow3= new BMap.InfoWindow("<p style='font-size:14px;'>苏大出版社 </p><p style='font-size:14px;'>温度:25.5  湿度:0.67</p><p style='font-size:14px;'>温湿度均正常</p>");
		marker3.addEventListener("click", function(){this.openInfoWindow(infoWindow3);});
		
		var marker4 = new BMap.Marker(new BMap.Point(120.64684,31.309817));  // 创建标注
        map.addOverlay(marker4);              // 将标注添加到地图中
		var infoWindow4= new BMap.InfoWindow("<p style='font-size:14px;'>苏大逸夫楼 </p><p style='font-size:14px;'>温度:25.4  湿度:0.64</p><p style='font-size:14px;'>温湿度均正常</p>");
		marker4.addEventListener("click", function(){this.openInfoWindow(infoWindow4);});
		
		var marker5 = new BMap.Marker(new BMap.Point(120.645987,31.310234));  // 创建标注
        map.addOverlay(marker5);              // 将标注添加到地图中
		var infoWindow5= new BMap.InfoWindow("<p style='font-size:14px;'>苏大工体楼 </p><p style='font-size:14px;'>温度:25.5  湿度:0.65</p><p style='font-size:14px;'>温湿度均正常</p>");
		marker5.addEventListener("click", function(){this.openInfoWindow(infoWindow5);});
		
		var marker6 = new BMap.Marker(new BMap.Point(120.646436,31.312008));  // 创建标注
        map.addOverlay(marker6);              // 将标注添加到地图中
		var infoWindow6= new BMap.InfoWindow("<p style='font-size:14px;'>苏大怡远楼 </p><p style='font-size:14px;'>温度:25.7  湿度:0.63</p><p style='font-size:14px;'>温湿度均正常</p>");
