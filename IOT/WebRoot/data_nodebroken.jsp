					...
					<div class="span12">
						<div class="portlet box blue ">
							<div class="portlet-title">
								<div class="caption  offset5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;节点故障率评估统计</div>
							</div>
							<div class="portlet-body form">
								<%
									DefaultPieDataset dpd = new DefaultPieDataset();
																					dpd.setValue("苏大文星阁监控群", 15);
																					dpd.setValue("苏大博物馆监控群", 45);
																					dpd.setValue("苏大出版社监控群", 25);
																					dpd.setValue("苏大逸夫楼监控群", 15);
																					dpd.setValue("苏大怡远楼监控群", 30);
																					dpd.setValue("苏大工体楼监控群", 20);
								...
								<img src="data_nodebroken.png" width="1000" height="600" />
